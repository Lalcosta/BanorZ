...
export default function App() {
  return (
    <NavigationContainer>
      <Drawer.Navigator useLegacyImplementation={true} initialRouteName="HomeScreen"
        screenOptions={{
          drawerActiveTintColor:'#fff',
          drawerInactiveTintColor:'#fff',
          drawerActiveBackgroundColor:'#f9133a',
          drawerStyle:{
        ...
        <Drawer.Screen name="Promociones y decuentos" backgroundColor='#fff' component={PromoScreen} />
